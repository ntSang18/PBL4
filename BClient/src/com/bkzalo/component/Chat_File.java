...
public class Chat_File extends javax.swing.JPanel {
    ...
    private com.bkzalo.swing.Progress progress1;
    ...
    public void setFile(String fileName, String size) {
        ...
        lbFileSize.setText(size+" byte");
    }

    @SuppressWarnings("unchecked")
    private void initComponents() {

        progress1 = new com.bkzalo.swing.Progress();
        jPanel1 = new javax.swing.JPanel();
        lbFileName = new javax.swing.JLabel();
        lbFileSize = new javax.swing.JLabel();

        progress1.setProgressType(com.bkzalo.swing.Progress.ProgressType.FILE);
