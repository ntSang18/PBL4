...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    public void setFile(Boolean right, String fileName, String fileSize) {
        txt.setFile(right, fileName, fileSize);
    }
    ...
    private void initComponents() {
        ...
        IaImage = new com.bkzalo.swing.ImageAvatar();
        txt = new com.bkzalo.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/bkzalo/icon/testing/dog.jpg"))); // NOI18N
    ...
    private com.bkzalo.swing.ImageAvatar IaImage;
