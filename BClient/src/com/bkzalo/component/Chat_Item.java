...
import com.bkzalo.component.Chat_File;
import com.bkzalo.component.Chat_Image;

import javax.swing.JButton;

public class Chat_Item extends javax.swing.JLayeredPane {
    private com.bkzalo.swing.JIMSendTextPane txt;
    ...
    public void setImage(boolean right, File file) {
        JLayeredPane layer = new JLayeredPane();
        layer.setLayout(new FlowLayout(right ? FlowLayout.RIGHT : FlowLayout.LEFT));
        layer.setBorder(new EmptyBorder(0, 5, 0, 5));
        Chat_Image chatImage = new Chat_Image(right);
        chatImage.addImage(file);
        layer.add(chatImage);
        add(layer);
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/bkzalo/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/bkzalo/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.bkzalo.swing.JIMSendTextPane();
