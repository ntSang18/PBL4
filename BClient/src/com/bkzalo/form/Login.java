...
import com.bkzalo.form.P_Login;
import com.bkzalo.form.P_Register;
...
public class Login extends javax.swing.JPanel {
    ...
    private com.bkzalo.swing.PanelSlide slide;
    ...
    private void init() {
        PublicEvent.getInstance().addEventLogin(new EventLogin() {
            ...
            public void login(Model_Account data) {
            	...
            	Service.Instance().Login(data);
            }

            @Override
            public void register(Model_Account data, EventErorMessage error) { 
            	Service.Instance().Register(data, error);
            }
    ...
    private void initComponents() {
        ...
        slide = new com.bkzalo.swing.PanelSlide();

        setBackground(new java.awt.Color(255, 255, 255));

        pic.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/bkzalo/icon/login_image1.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(66, 66, 66));
        jLabel2.setText("BKZalo");
