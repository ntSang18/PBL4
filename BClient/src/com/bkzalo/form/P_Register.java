...
public class P_Register extends javax.swing.JPanel {
    ...
    private void cmdRegisterActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (userName.equals("")) {
        	...
        	Model_Account data = new Model_Account(userName, password);
			/* Register */
            PublicEvent.getInstance().getEventLogin().register(data, new EventErorMessage() {
                @Override
                public void callErorMessage(Model_Error message) {
                    if (!message.isAction()) {
