...
import com.bkzalo.swing.Progress;
...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/bkzalo/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/bkzalo/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/bkzalo/icon/file.png")).getImage();
    }
